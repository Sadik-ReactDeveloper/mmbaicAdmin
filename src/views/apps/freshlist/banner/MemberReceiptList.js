...
class MemberReceiptList extends React.Component {
  state = {
    rowData: [],
    CurrectReceipt: {},
    Viewpermisson: null,
  ...
  async componentDidMount() {
    ...
    let newparmisson = pageparmission?.role?.find(
      (value) => value?.pageName === "Membership Receipt List"
    );
    ...
    await axiosConfig
      .post("/getMemberlistCompletePay", data)
      .then((response) => {
        // debugger;
...
export default MemberReceiptList;
