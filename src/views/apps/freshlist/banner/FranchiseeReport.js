...
class FranchiseeReport extends React.Component {
  state = {
    rowData: [],
    CurrectReceipt: {},
    Viewpermisson: null,
  ...
  async componentDidMount() {
    ...
    await axiosConfig.post("/getFranchiseReport", data).then((response) => {
      // debugger;
...
export default FranchiseeReport;
