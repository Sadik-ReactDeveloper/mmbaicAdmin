...
class RefrralUserList extends React.Component {
  state = {
    rowData: [],
    CurrectReceipt: {},
    Viewpermisson: null,
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div>
              <span>
                {params.data?.refer_firstname} {params.data?.refer_lastname}
              </span>
            </div>
          );
        },
  ...
  async componentDidMount() {
    ...
    let newparmisson = pageparmission?.role?.find(
      (value) => value?.pageName === "All Referral List"
    );
    ...
    await axiosConfig.post("/getReferalUsers", data).then((response) => {
...
export default RefrralUserList;
