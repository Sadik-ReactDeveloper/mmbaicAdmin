...
class AffiliatedWalletList extends React.Component {
  state = {
    rowData: [],
    CurrectReceipt: {},
    Viewpermisson: null,
  ...
  async componentDidMount() {
    ...
    let newparmisson = pageparmission?.role?.find(
      (value) => value?.pageName === "Affiliated Wallet"
    );
    ...
    await axiosConfig.post("/getUsersWalletBal", data).then((response) => {
      //   debugger;
...
export default AffiliatedWalletList;
