...
class FranchiseeBilling extends React.Component {
  state = {
    rowData: [],
    CurrectReceipt: {},
    Viewpermisson: null,
  ...
  async componentDidMount() {
    ...
    await axiosConfig.post("/getFranchiseBilling", data).then((response) => {
      // debugger;
...
export default FranchiseeBilling;
