...
class FranChiseeAffiliated extends React.Component {
  state = {
    rowData: [],
    Viewpermisson: null,
    Editpermisson: null,
                ...
                <Route
                  render={({ history }) => (
                    <BsViewList
                      ...
                      onClick={() =>
                        history.push(
                          `/app/mmbaic/house/FranciseeAffiliatedInsiderMembers/${params?.data?.id}/${params?.data?.firstname}_${params?.data?.lastname}`
                        )
                      }
                    />
                  )}
  ...
  async componentDidMount() {
    ...
    await axiosConfig
      .post("/getFranchiseAffiliatedMemberlist", formdata)
      .then((response) => {
              ...
              <Row className="m-2">
                <Col>
                  <h1 col-sm-6 className="float-left">
                    Franchisee Affiliated Members List
                  </h1>
                </Col>
                {/* <Col>
                  <Route
...
export default FranChiseeAffiliated;
