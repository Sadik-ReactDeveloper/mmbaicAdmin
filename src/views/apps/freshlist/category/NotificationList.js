...
class NotificationList extends React.Component {
    ...
    columnDefs: [
      ...
      },
      {
        ...
        cellRendererFramework: (params) => {
          return (
            <div className="d-flex align-items-center cursor-pointer">
              <span>{params?.data?.notificationtype}</span>
            </div>
          );
        },
      },
                ...
                <Route
                  render={({ history }) => (
                    <Edit
                      ...
                      onClick={() =>
                        history.push(
                          `/app/mmbaic/category/AddNotificaton/${params?.data?.id}`
                        )
                      }
                    />
                  )}
  ...
  async componentDidMount() {
    ...
    let newparmisson = pageparmission?.role?.find(
      (value) => value?.pageName === "Notification List"
    );
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(
                            `/app/mmbaic/category/AddNotificaton/${0}`
                          )
                        }
                      >
                        + Notification
