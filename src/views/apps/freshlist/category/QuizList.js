                ...
                <Route
                  render={({ history }) => (
                    <Edit
                      ...
                      onClick={() =>
                        history.push(
                          `/app/mmbaic/category/AddQuiz/${params?.data?.course_id}/${params?.data?.id}`
                          // `/app/freshlist/category/editCategory/${params?.data?.id}`
                        )
                      }
                    />
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(`/app/mmbaic/category/AddQuiz/${0}/${0}`)
                        }
                      >
                        + Quiz
                      </Button>
