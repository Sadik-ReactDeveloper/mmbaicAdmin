                  ...
                  render={({ history }) => (
                    <Edit
                      ...
                      onClick={() => {
                        ...
                        this.setState({ type: params?.data?.type });
                        this.setState({ EditId: params?.data?.id });
                        this.setState({ Email: params?.data?.emails });
                      }}
                    />
                  )}
                />
                ...
                {this.state.AddEmail && (
                  <Button
                    onClick={(e) => {
                      ...
                      data.append("emails", this.state.Email);

                      if (this.state.type && this.state.Email) {
                        axiosConfig
                          .post("/addemails", data)
                          .then((response) => {
                        ...
                        swal("Enter Details to Send Emails");
                      }
                    }}
                    color="primary"
                  >
