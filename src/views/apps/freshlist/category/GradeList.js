                ...
                <Route
                  render={({ history }) => (
                    <Edit
                      ...
                      onClick={() =>
                        history.push(
                          `/app/mmbaic/category/AddGrade/${params?.data?.id}`
                        )
                      }
                    />
                  )}
                  ...
                  <Route
                    render={({ history }) => (
                      <Button
                        ...
                        onClick={() =>
                          history.push(`/app/mmbaic/category/AddGrade/${0}`)
                        }
                      >
                        + Grades
                      </Button>
